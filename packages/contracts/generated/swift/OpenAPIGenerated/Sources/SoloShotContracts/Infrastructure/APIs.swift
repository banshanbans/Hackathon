...
open class SoloShotContractsAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "http://localhost:8000",
    ...
    public static let shared = SoloShotContractsAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: SoloShotContractsAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: SoloShotContractsAPIConfiguration = SoloShotContractsAPIConfiguration.shared
    ) {
        self.method = method
