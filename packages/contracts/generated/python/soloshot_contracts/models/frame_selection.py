...
class FrameSelection(BaseModel):
    ...
    timestamp_ms: Optional[Annotated[int, Field(strict=True, ge=0)]]
    selection_source: StrictStr
    __properties: ClassVar[List[str]] = ["frame_id", "timestamp_ms", "selection_source"]

    @field_validator('frame_id')
    def frame_id_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FrameSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FrameSelection from a dict"""
        if obj is None:
            return None
